...
const Banner = () => {
  return (
    <div>
      {" "}
      <div className="w-full border border-primary-border rounded-xl flex justify-between items-center ">
      ...
      <div className=" w-full border border-primary-border rounded-xl   p-2 flex mt-4">
        ...
        <div className=" flex flex-1 justify-between">
          <p className="mx-4">#1: BTC</p>
          <p className="mx-4">#2: ETH</p>
          <p className="mx-4">#3: BNB</p>
          <p className="mx-4">#4: PURE</p>
          <p className="mx-4">#5: SHIB</p>
          <p className="mx-4">#6: XRP</p>
          <p className="mx-4">#7: EOS</p>
          <p className="mx-4">#8: LUNA</p>
          <p className="mx-4">#9: FINU</p>
          <p className="mx-4">#10: RDC</p>
        </div>
      </div>
    </div>
  );
